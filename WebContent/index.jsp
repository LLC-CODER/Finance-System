...
<body class="easyui-layout"> 
	...
	<!-- 上begin  -->  
    <div data-options="region:'north'" style="height:100px; background-image: url('/wc/statics/img/photo.jpg'); background-repeat: no-repeat;">
    	<div style="margin-top: 75px;margin-left: 90px;font-size: 20px">
    		<a href="/wc/index.jsp" style="text-decoration: none;">财务管理系统</a>
    ...
    <div data-options="region:'south'" style="height:50px;text-align: center;color: blue;">
    	<br>
		Copyright © LLC&emsp;&emsp;
		QQ：763163830 <a href="#" class="go-top"> <i class="icon-bon-arrow-up"></i></a>
    </div>   
    <!-- 下end --> 
    ...
    <!-- 左begin  -->  
    <div data-options="region:'west',title:'导航栏'" style="width:170px;">
	    <div id="aa" class="easyui-accordion" style="width:100%;height:100%;">   
	    <div title="功能模块" data-options="iconCls:'icon-tip'" style="overflow:auto;padding:10px;">  
	    ...
	    <div title="系统设置" data-options="iconCls:'icon-item'" style="padding:10px;">   
