...
<body
	style="background-image: url(/wc/statics/img/bg.jpg); background-repeat: no-repeat;">
	<div
		style="margin-left: 50%; margin-top: 150px; background-color: #fafafa; margin-right: 20%">
		<div id="p" class="easyui-panel"
			style="width: 415px; height: 250px; padding: 25px; background: #fafafa;"
			...
			<div style="padding: 20px 0 10px 60px">
				<form id="loginForm" action="/wc/user" method="post">
					...
					<table>
						<tr>
							<td>用户名称：</td>
							<td><input id="uname" name="uname" type="text" value="" <%-- value="${user.name }" --%> /></td>
						</tr>
						<tr>
							<td>用户密码：</td>
							<td><input id="upwd" name="upwd" type="password" value="" <%-- value="${user.pwd }" --%> /></td>
						</tr>
						<tr>
							<td></td>
